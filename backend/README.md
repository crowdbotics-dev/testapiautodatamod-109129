...
## Project Structure
    ...
    ├── testapiautodatamod_109129  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_109129`
...
2. Clone this repo and `cd testapiautodatamod_109129`
